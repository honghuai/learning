...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutationsxx = {
	    //mutations叫做‘触发状态’，需要用commit来触发mutations状态【同步】
	    increase: function increase(state, v) {
	        console.log(v);
	        state.count += v.n | 1;
	    },
	    descrease: function descrease(state) {
	        state.count--;
	    }
	};
	/*getter相关start
	...
	* */
	 ...
	 * */
	var actions = {
	    increaseplus: function increaseplus(context) {
	    ...
	    descreaseplus: function descreaseplus(_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by honghuai on 2016/12/25.
	 */
	!(__WEBPACK_AMD_DEFINE_FACTORY__ = (state = {
	    count: 7,
	    version: '0.0.1',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "F:\\vue-webpack\\src\\js\\store\\vuex.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: (0, _extends3.default)({}, (0, _vuex.mapMutations)(['increase']), (0, _vuex.mapActions)(['increaseplus']), (0, _vuex.mapActions)({
